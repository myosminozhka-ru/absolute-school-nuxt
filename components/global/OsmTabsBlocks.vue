    ...
    .tabs_blocks {
        ...
        &__buttons {
            ...
            &:before {
                ...
                bottom: 0;
                position: absolute;
                background: linear-gradient(270deg, #FFF9E4 40.91%, rgba(255, 249, 228, 0.57) 72.13%, rgba(255, 253, 247, 0) 100%);
                width: 20px;
                height: 100%;
                z-index: 3;
            }
