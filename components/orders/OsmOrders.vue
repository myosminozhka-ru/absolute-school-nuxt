<template>
    <div class="orders center-block">
        <osm-orders-block v-for="order in $store.state.orders.orders" :key="order.id" :order="order"/>
